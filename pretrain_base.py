...
from data_helper_zyc import CustomDataCollator, CustomDataset, GraphDataset, VerilogGraphDataset
from aigmae.configuration_vgmae import AIGMAEConfig
from aigmae.modeling_vgmae_attention import AIGMAEModel,AIGMAEModel_cross
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    dataloader_num_workers: int = field(
        default=4, metadata={"help": "DataLoader 进程数，128核CPU建议设为16"}
    )
